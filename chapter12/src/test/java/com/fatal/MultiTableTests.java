...
public class MultiTableTests
{
    ...
    {
        // 与手动添加id的Customer关联
        Address address1 = new Address().setCustomerId("137063").setAddress("shantou");
        Address address2 = new Address().setCustomerId("137063").setAddress("guangzhou");
        // 与自动生成id的Customer关联
        Address address3 = new Address().setCustomerId("5d4e908fe429c66df040ae69").setAddress("foshan");
        Address address4 = new Address().setCustomerId("5d4e908fe429c66df040ae69").setAddress("hangzhou");
