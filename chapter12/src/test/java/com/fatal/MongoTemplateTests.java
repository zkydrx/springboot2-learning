...
public class MongoTemplateTests
{
    ...
    public void before()
    {
         ...
         */
        customer = new Customer().setId("137063").setName("fatal").setAge(18).setPhone("13750411111").setBirthday(new Date()).setHobby("swim");
    ...
    {
        Query query = new Query(Criteria.where("id").is("137063").and("name").is("fatal1"));
