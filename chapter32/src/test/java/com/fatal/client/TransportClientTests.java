...
public class TransportClientTests extends Chapter32ApplicationTests
{
    ...
    public void indexTest()
    {
        try
        {
            XContentBuilder xContentBuilder = XContentFactory.jsonBuilder().startObject().field("name", "佛山").field("theDetail", "佛山文化").endObject();
            IndexResponse indexResponse = client.prepareIndex("city", "city_search").setSource(xContentBuilder).get();
    ...
    public void updateTest()
    {
        ...
        try
        {
            XContentBuilder xContentBuilder = XContentFactory.jsonBuilder().startObject().field("name", "北京").field("theDetail", "北京文化").endObject();
    ...
    {
        IdsQueryBuilder queryBuilder = QueryBuilders.idsQuery().addIds("uN_0ZW0BEkPQvsGlN3m_", "tN_uZW0BEkPQvsGlu3m_");
    ...
    public void highLightTest()
    {
        ...
        HighlightBuilder highlightBuilder = new HighlightBuilder().field("name").field("theDetail");
        SearchResponse searchResponse = client.prepareSearch("city").setQuery(queryBuilder).highlighter(highlightBuilder).get();
    ...
    {
        return client.prepareSearch("city").setTypes("city_search").setQuery(queryBuilder).get();
    }
